events.listen('item.tags', function (e) {
    ...
    e.add('forge:dusts', ['kubejs:silver_dust', 'kubejs:craunium_dust', 'kubejs:hop_graphite_dust', 'kubejs:sulfur_dust', 'kubejs:electrum_dust', 'kubejs:constantan_dust', 'kubejs:diamond_dust'])
